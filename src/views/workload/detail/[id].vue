...
const handleDeleteTheoryTeaching = async (item: TheoryTeaching) => {
  try {
    const response = await fetch('http://127.0.0.1:4523/m1/7011946-6730589-default/workload/theory/delete', {
      method: 'POST',
      headers: {
...
const practiceTeachingList: PracticeTeaching[] = [
  {
    courseName: 'Web开发实训',
    practiceType: '实训',
    practiceHours: 32,
...
<template>
  <div class="h-full flex-col">
    ...
    <div class="flex-1 space-y-32px">
      ...
      <!-- 实践教学工作量 -->
      <div>
        <h3 class="mb-16px text-18px font-medium">实践教学工作量</h3>
        <NTable :bordered="true" :single-line="false">
          <thead>
            <tr>
              <th>课程名称</th>
